  ...
  return (
    <div className={cn('fixed inset-0 z-50 flex items-center justify-center', className)}>
      ...
      <div className="relative bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4 p-8">
        ...
        <div className="mb-8">
          <h2 className="text-2xl font-light text-ds-dark-blue text-center">
            How can we help you find something?
          </h2>
        </div>
        <form onSubmit={handleSearch} className="space-y-6">
          ...
          <div className="flex justify-center">
            <Button
              type="submit"
              size="lg"
              className="bg-ds-accent-yellow hover:bg-ds-accent-yellow/90 text-ds-dark-blue font-semibold px-8"
            >
              Search
            </Button>
          </div>
