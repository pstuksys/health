...
export function SleepAssessmentFeatures({
  ...
  const defaultFeatures = [
    ...
    },
    {
      ...
      description:
        'Receive a detailed analysis of your sleep disorder risk with clear next steps.',
      icon: 'CheckCircle' as IconKey,
    },
    {
      title: 'Expert Support',
      description:
        'Connect with our sleep specialists to discuss your results and next steps.',
        ...
        {featuresToRender.map((feature, index) => {
          ...
          return (
            ...
            >
              ...
              {/* Title */}
              <h3 className='text-lg font-semibold text-ds-dark-blue mb-3'>
                {feature.title}
              </h3>
