        ...
        <div className="space-y-12">
          {displayMembers.map((member, index) => (
            ...
            >
              <div
                className={cn(
                  'mx-auto max-w-7xl py-8 px-6 md:px-8',
                  'flex flex-col md:flex-row md:items-start gap-8 md:gap-12',
                )}
              >
                {/* Left: Profile Image + Name + Title */}
                <div className="flex-shrink-0 mx-auto md:mx-0">
                  <div className="relative w-[220px] h-[220px] md:w-60 md:h-60 overflow-hidden rounded-full group cursor-pointer hover:shadow-2xl transition-all duration-300">
                    <Image
                      src={
                      ...
                      <div className="flex gap-3 opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-300 delay-100">
                        {member.linkedin && (
                          <CMSLink
                            ...
                            variant="default"
                            className="bg-white bg-opacity-95 hover:bg-opacity-100 text-ds-accent-yellow p-3 rounded-full transition-all duration-200 hover:scale-110 shadow-lg"
                          >
                  ...
                  <div className="mt-6 max-w-[240px] md:max-w-[300px]">
                    <h3 className="text-xl text-ds-dark-blue text-center font-semibold">
                      {member.name}
                    </h3>
                    {member.role && (
                      <p className="mt-1 text-sm font-semibold text-ds-pastille-green text-center">
                        {member.role}
                      </p>
                    )}
                  </div>
                ...
                {/* Right: Description - Takes up remaining space (~75%) */}
                <div className="flex-1 text-center md:text-left">
                  <div className="text-ds-pastille-green leading-relaxed text-lg">
